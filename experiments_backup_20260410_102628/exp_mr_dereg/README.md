...
**结果位置**: 本实验的结果保存在 `results/` 目录下
- `results/victim_no_protection.csv` - 场景A（无拦截）数据
- `results/victim_no_protection.png` - 场景A可视化图表
- `results/victim_with_protection.csv` - 场景B（有拦截）数据
- `results/victim_with_protection.png` - 场景B可视化图表
...
./RdmaEngine \
    ...
    --duration=30 \
    --test_mode=write \
    --output=results/victim_no_protection.csv

# 输出文件: results/victim_no_protection.csv
...
# 预期输出:
# ========================================
# Results: results/victim_no_protection.csv
# ========================================
# Samples:          300 points
...
# ========================================
#
# Plot saved to: results/victim_no_protection.png
```
...
LD_PRELOAD=./build/librdma_intercept.so \
    ...
    --duration=30 \
    --test_mode=write \
    --output=results/victim_with_protection.csv
